...
for i,col in enumerate(color): #каждое значение соответствует количеству пикселей в этом изображении с соответствующим значением пиксел€ RGB
      histr = cv2.calcHist([frame],[i],None,[256],[0,256])
      plt.plot(histr,color = col)
      plt.xlim([0,256])

# —оздание медиа-сервиса
